...
- Calendar・Drive・Classroomを授業単位で統合するLessonBundle
- 授業予定、Drive資料、Classroom課題・教材のGUI確認
- 教師承認後のClassroom Topic・教材・課題作成
...
7. ダッシュボードでCalendar予定を選び、Drive・Classroomの授業データを統合する
8. 教師が確認した教材または課題をClassroom Topicへ公開する
...
授業ナレッジ統合の詳細は [docs/lesson-knowledge-integration.md](docs/lesson-knowledge-integration.md) を参照してください。
